                                ...
                                <form id="frmEtiquette" action="{{ route('bordereau.bordereau') }}" method="post">
                                    ...
                                    <select name="pays" id="">                                            
                                        ...
                                        @foreach ($pays as $item)
                                            <option value="{{$item->code_pays}}">{{$item->pays}}</option>                                        
                                        @endforeach 
                                    </select>
                                {{-- </form> --}}
                                {{-- @yield('pays') --}}
                                ...
                                {{-- <form id="frmArticles" action="#"> --}}
                                    <select name="articles" id="">                                            
                                        ...
                                        @foreach ($articles as $item)
                                            <option value="{{$item->code_article}}">{{$item->article}}</option>                                        
                                        @endforeach 
                                    </select>
                                {{-- </form> --}}
                                {{-- @yield('articles') --}}
                                ...
                                {{-- <form id="frmFournisseurs" action="#"> --}}
                                    <select name="fournisseurs" id="">                                            
                                        ...
                                        @foreach ($fournisseurs as $item)
                                            <option value="{{$item->code_fournisseur}}">{{$item->fournisseur}}</option>                                        
                                        @endforeach 
                                    </select>
                                {{-- </form> --}}
                                {{-- @yield('fournisseurs') --}}
                                ...
                                {{-- <form id="frmOperateurs" action="#"> --}}
                                    <select name="operateurs" id="">                                            
                                        ...
                                        @foreach ($operateurs as $item)
                                            <option value="{{$item->code_operateur}}">{{$item->operateur}}</option>                                        
                                        @endforeach 
                                    </select>
                                </form>
                                {{-- @yield('operateurs') --}}
