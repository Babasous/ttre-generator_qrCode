...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>TTRE: Code Tracking</title>
    ...
    <body class="antialiased">
               ...
               {{--  <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div>
                    <div style="display: flex">
                        ...
                        <b><h1 id="code" style="padding: 30px; font-size: 30px"></h1></b>
                    </div>
                    <div>
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <button id="borderau" type="submit" style="margin-left: 110px; margin-top: 20px; color: white; background-color: #1E9C07" class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">Générer le borderau d'enlevement</button>                          

                    

                    <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0" style="margin-left: 200px; padding-top: 10px">
        ...
        <script>
            ...
            etiquette.onclick = function(){
                if(!(frmPays.pays.value === '') && !(frmFournisseurs.fournisseurs.value === '') && !(frmArticles.articles.value === '') && !(frmOperateurs.operateurs.value === '')){
                    code.innerHTML = (frmPays.pays.value).toUpperCase();
                    code.innerHTML += frmFournisseurs.fournisseurs.value;
                    code.innerHTML += frmArticles.articles.value;
                    code.innerHTML += frmOperateurs.operateurs.value;
                    cpt++;
                    code.innerHTML += cpt;
                    code.innerHTML += '-';
                    ...
                    code.innerHTML = 'Champs manquant !!!'
